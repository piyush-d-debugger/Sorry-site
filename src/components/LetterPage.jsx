    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8">
      ...
      >
        ...
        >
          ...
          >
            Har baar ulti seedhi harkat karte rehta hu just to make you happy , but I still end up hurting you… I'm so sorry.💔
          </motion.p>
          ...
          >
            I know words can't undo what I did, nahi jaati tu dimag se , I don't want to do this . I want to talk with you.. keep sharing things.. have fun whole heartedly but not by forcing you in any means , I miss you more than I remember you  ✨
          </motion.p>
          <motion.p
